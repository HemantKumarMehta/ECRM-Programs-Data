...
df = pd.read_csv("container_meta-quarter.csv", usecols=[6] , sep=",", header=None)
X=df.values
size = int(len(X) * 0.95)
...
for t in range(len(test)):
	model = ARIMA(history, order= (1,1,0)) # (3,0,1) (5,0,1)  (7,0,1)**  (3,1,0) (5,1,0) (7,1,0) (1,1,0)*
...
df.to_csv("results-C6-quarter.csv", index=False)
