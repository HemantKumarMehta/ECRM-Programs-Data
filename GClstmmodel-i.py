...
numpy.random.seed(7)
dataframe =  pd.read_csv("GC-EDGE-CMD.csv", usecols=[3] , sep=",", header=None) #pd.read_csv("/home/ecrm/arima/DS6-trace.csv", usecols=[4] , sep=",", header=None) #pd.read_csv("/home/ecrm/arima/DS1-trace.csv", usecols=[4] , sep=",", header=None) #pd.read_csv("/home/ecrm/arima/cnewcountdata10Min.csv", usecols=[11] , sep=",", header=None)
...
df.to_csv("GClstmresults-EDGE-i.csv", index=False)
