...
numpy.random.seed(7)
dataframe = pd.read_csv("DS6-trace.csv", usecols=[4] , sep=",", header=None) #pd.read_csv("/home/ecrm/arima/DS1-trace.csv", usecols=[4] , sep=",", header=None) #pd.read_csv("/home/ecrm/arima/cnewcountdata10Min.csv", usecols=[11] , sep=",", header=None)
...
#df.to_csv("lstmresults-ds6.csv", index=False)
